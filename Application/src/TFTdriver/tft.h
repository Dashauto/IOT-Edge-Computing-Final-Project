...
#define MYCOLOR   0x901f


#define DAT_PIN PIN_PA03
#define SLAVE_SELECT_PIN PIN_PB02
#define CONF_MASTER_MUX_SETTING SPI_SIGNAL_MUX_SETTING_K
#define CONF_MASTER_PINMUX_PAD0 PINMUX_UNUSED
#define CONF_MASTER_PINMUX_PAD1 PINMUX_PA17D_SERCOM3_PAD1
#define CONF_MASTER_PINMUX_PAD2 PINMUX_PA20D_SERCOM3_PAD2
#define CONF_MASTER_PINMUX_PAD3 PINMUX_PA21D_SERCOM3_PAD3
...
void LCD_drawYLine(short x,int c);
void LCD_drawXLine(short y,int c);
...
void spi_io(unsigned char); // send and rx a byte over spi

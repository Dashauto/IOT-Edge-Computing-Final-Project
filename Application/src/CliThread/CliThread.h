...
BaseType_t get_tick(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString);
BaseType_t firmware_get_version(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString);
